...
/**
 * struct global_s - these are variables -> args, file, line content
 * @arg: value
 * @line: input line content
 * @file: this is the pointer to monty file
 *
 * Description: this is variable that carries values through the program
 */
...
/**
 * struct stack_s - this is  doubly linked list representation of a stack (or queue)
 * @n: integer
 * @prev:it  points to the previous element of the stack (or queue)
 * @next: it points to the next element of the stack (or queue)
 *
 * Description: this is doubly linked list node structure
...
/**
 * struct instruction_s - it is the opcode and its function
